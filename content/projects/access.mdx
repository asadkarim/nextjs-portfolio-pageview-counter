...
description: Platform & Tools: Business Central, Power Automate, Excel BI dashboards
Goal: Integrate multiple warehouses, streamline procurement, and automate sales order processing.
